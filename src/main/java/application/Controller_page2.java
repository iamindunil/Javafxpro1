...
public class Controller_page2 {
    ...
    public void create_list_movies() {
        ...
        try (Connection connection = DriverManager.getConnection(connectionUrl)) {
            ...
            String sql2 = "SELECT count(*) FROM (\n" +
                    ...
                    "    UNION\n" +
                    "    SELECT M_name, imdb_ratings, ((select count(*) from animemovie) + (ROW_NUMBER() OVER (ORDER BY M_name))) AS mid FROM Lactionmovie\n" +
                    ") AS subquery;";
    ...
    public void switchtoinfo1(String name) throws IOException {
        showinfo(name);
        System.out.println(name);
    }
    public void showinfo(String name) throws IOException {
        Con2 con2 = new Con2();
        con2.setname(name);
        con2.Createstg();
    }
